...
func NewAppClientDao(client utils.Map) AppClientDao {
	var daoAppClient AppClientDao = nil
	...
	case db_common.DATABASE_TYPE_MONGODB:
		daoAppClient = &mongodb_repository.AppClientMongoDBDao{}
