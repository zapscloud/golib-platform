...
func (p *SysClientMongoDBDao) InitializeDao(client utils.Map) {
	log.Println("Initialize SysClientMongoDBDao")
	p.client = client
}
...
func (t SysClientMongoDBDao) List(filter string, sort string, skip int64, limit int64) (utils.Map, error) {
	...
	log.Println("Begin - Find All Collection Dao", platform_common.DbPlatformSysClients)
...
func (t SysClientMongoDBDao) GetDetails(userid string) (utils.Map, error) {
	...
	log.Println("SysClientMongoDBDao::Find:: Begin ", userid)
	...
	log.Printf("SysClientMongoDBDao::Find:: End Found a single document: %+v\n", result)
	return result, nil
}
...
func (t SysClientMongoDBDao) Find(filter string) (utils.Map, error) {
	...
	log.Println("SysClient::Find:: Begin ", filter)
	...
	log.Printf("SysClient::Find:: End Found a single document: %+v\n", result)
	return result, nil
}
...
func (t SysClientMongoDBDao) Delete(userid string) (int64, error) {
	...
	log.Println("SysClientMongoDBDao::Delete - Begin ", userid)
	...
	log.Printf("SysClientMongoDBDao::Delete - End deleted %v documents\n", res.DeletedCount)
